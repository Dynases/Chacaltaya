...
#Region "Metodos Privados"
    ...
    Private Sub _PHabilitarFocus()
        ...
        HighLigthter_Focus.SetHighlightOnFocus(Tb_BonoImporte, DevComponents.DotNetBar.Validator.eHighlightColor.Blue)
        HighLigthter_Focus.SetHighlightOnFocus(Tb_BonoMeses, DevComponents.DotNetBar.Validator.eHighlightColor.Blue)
        HighLigthter_Focus.SetHighlightOnFocus(Tb_VacacionesDias, DevComponents.DotNetBar.Validator.eHighlightColor.Blue)
        HighLigthter_Focus.SetHighlightOnFocus(Tb_VacacionesMeses, DevComponents.DotNetBar.Validator.eHighlightColor.Blue)
...
#Region "Bono Antiguedad"
    ...
    Private Sub _PInhabilitar1()
        ...
        BBtn_Grabar1.Image = My.Resources.GRABAR
        BBtn_Grabar1.ImageLarge = My.Resources.GRABAR
    ...
    Private Sub _PGrabarRegistro1()
        ...
        If _Nuevo1 Then
            ...
            Tb_BonoMeses.Focus()
            ToastNotification.Show(Me, "Codigo de Bono Antiguedad " + numi + " Grabado con Exito.", My.Resources.GRABACION_EXITOSA, 5000, eToastGlowColor.Green, eToastPosition.BottomLeft)
            'Tsbl0_Mensaje.Text = ""
            _PLimpiar1()
        Else
            Dim numi As String = Tb_id1.Text
            ...
            ToastNotification.Show(Me, "Codigo de Bono Antiguedad " + numi + " Modificado con Exito.", My.Resources.GRABACION_EXITOSA, 5000, eToastGlowColor.Green, eToastPosition.BottomLeft)
...
#Region "Vacaciones"
    ...
    Private Sub _PInhabilitar2()
        ...
        BBtn_Grabar2.Image = My.Resources.GRABAR
        BBtn_Grabar2.ImageLarge = My.Resources.GRABAR
    ...
    Private Sub _PGrabarRegistro2()
        ...
        If _Nuevo2 Then
            ...
            ToastNotification.Show(Me, "Codigo Vacacion " + numi + " Grabado con Exito.", My.Resources.GRABACION_EXITOSA, 5000, eToastGlowColor.Green, eToastPosition.BottomLeft)
            'Tsbl0_Mensaje.Text = ""
            _PLimpiar2()
        Else
            Dim numi As String = Tb_id2.Text
            ...
            ToastNotification.Show(Me, "Codigo de Vacacion " + numi + " Modificado con Exito.", My.Resources.GRABACION_EXITOSA, 5000, eToastGlowColor.Green, eToastPosition.BottomLeft)
...
#End Region
    ...
    Private Sub P_Bonos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        _PIniciarTodo()
    End Sub

    Private Sub BBtn_Nuevo1_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Nuevo1.Click
        _PNuevoRegistro1()
    End Sub

    Private Sub BBtn_Grabar1_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Grabar1.Click
        _PGrabarRegistro1()
    End Sub

    Private Sub BBtn_Cancelar1_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Cancelar1.Click
        _PSalirRegistro1()
    End Sub
    ...
    Private Sub BBtn_Eliminar1_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Eliminar1.Click
        _PEliminarRegistro1()
    End Sub

    Private Sub BBtn_Modificar1_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Modificar1.Click
    ...
    Private Sub BBtn_Nuevo2_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Nuevo2.Click
        _PNuevoRegistro2()
    End Sub

    Private Sub BBtn_Modificar2_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Modificar2.Click
        _PModificarRegistro2()
    End Sub

    Private Sub BBtn_Eliminar2_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Eliminar2.Click
        _PEliminarRegistro2()
    End Sub

    Private Sub BBtn_Grabar2_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Grabar2.Click
        _PGrabarRegistro2()
    End Sub

    Private Sub BBtn_Cancelar2_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Cancelar2.Click
        _PSalirRegistro2()
    End Sub
