...
#End Region
    ...
    Private Sub btnguardar_Click(sender As Object, e As EventArgs) Handles btnguardar.Click
        If _PMOValidarCampos() = True Then
            ...
            If (estadoPedido = 2 And tipoReclamo = 1) Then
                L_PedidoCabacera_ModificarEstado(numiPedido, 1)
            End If
            respuesta = True
            'P_PedidosAsignacion.P_prActualizarDictados()
            'P_PedidosAsignacion.P_prActualizarPendientes()
            Me.Close()
        End If
    End Sub
