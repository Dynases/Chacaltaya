...
Public Class R_FacturaVsVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FacturaVsVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FacturaVsVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturaVsVenta = New R_FacturaVsVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
