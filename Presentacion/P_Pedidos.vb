...
#Region "Metodos Privados"
    ...
    Private Sub _PAsignarPermisos()
        ...
        Dim dtRolUsu As DataTable = L_RolDetalle_General2(-1, idRolUsu, "ycyanumi=8")
    ...
    Private Sub _PCargarBuscador(Optional where As String = "")
        ...
        If _nuevoBasePeriodico = True Then
            JGr_Buscador.DataSource = L_PedidoCabecera_General(-1, " AND oaest=10" + where)
        Else
        ...
        With JGr_Buscador.RootTable.Columns("cctelf2")
    ...
    Private Sub _PCargarGridTiposProd()
        Dim dtProd, dtCatPrecios As New DataTable
        dtProd = L_General_LibreriaDetalle(-1, 5).Tables(0)
    ...
    Private Sub _PInhabilitar()
        ...
        'Tb_Zona.Enabled = False
        'Tb_Observaciones.Enabled = False
        'Tb_CliCateg.Enabled = False
        'Tb_CliCod.Enabled = False
        'Tb_CliCodZona.Enabled = False
        'Tb_CliDireccion.Enabled = False
        'Tb_CliNombre.Enabled = False
        'Tb_CliTelef.Enabled = False
        'Tb_Estado.Enabled = False
        'Tb_Obs.Enabled = False
        'Tb_Obs2.Enabled = False
        'Tb_PromCosumo.Enabled = False
        'Tb_TotalPedidos3Meses.Enabled = False
        Tb_Id.ReadOnly = True
        Tb_Fecha.Enabled = False
    ...
    Private Sub _PMostrarRegistro(_N As Integer)
        ...
        With JGr_Buscador '_Dsencabezado.Tables(0).Rows(_N)
            ...
            Tb_CliTelef.Text = IIf(IsDBNull(.GetValue("cctelf2")), "", .GetValue("cctelf2"))
        ...
        Txt_Paginacion.Text = Str(_N + 1) + "/" + JGr_Buscador.RowCount.ToString '_Dsencabezado.Tables(0).Rows.Count.ToString
    End Sub
    ...
    Private Sub _PGrabarRegistro()
        ...
        If _PValidar() Then
            Exit Sub
        End If
        If btGrabar.Enabled = False Then
            Exit Sub
        End If

        If False Then 'btGrabar.Tag = 0
            btGrabar.Tag = 1
            btGrabar.Image = My.Resources.CONFIRMACION
            btGrabar.ImageLarge = My.Resources.CONFIRMACION
            BubbleBar6.Refresh()
            ''
            Btn_TerminarAdd.Image = My.Resources.CONFIRMACION
            Exit Sub
        Else
            btGrabar.Tag = 0
        ...
        If _Nuevo Then
            ...
            L_PedidoCabecera_Grabar(Tb_Id.Text, Date.Now.Date.ToString("yyyy/MM/dd"), Tb_Hora.Text, Tb_CliCod.Text, Tb_CliCodZona.Text, Tb_Observaciones.Text, IIf(_nuevoBasePeriodico = True, "10", "1"), "1", "0")
            ...
            L_PedidoEstados_Grabar(Tb_Id.Text, IIf(_nuevoBasePeriodico = True, "10", "1"), Date.Now.Date.ToString("yyyy/MM/dd"), Tb_Hora.Text, gs_usuario)
            ...
            JGr_Clientes.Col = 1
        Else
            L_PedidoCabacera_Modificar(Tb_Id.Text, Tb_Fecha.Value.ToString("yyyy/MM/dd"), Tb_Hora.Text, Tb_CliCod.Text, Tb_CliCodZona.Text, Tb_Observaciones.Text, IIf(_nuevoBasePeriodico = True, "10", "1"))
    ...
    Private Sub _PGenerarPedidosPeriodicamente()
        ...
        If grabar = True Then
            ...
            L_PedidoCabecera_Grabar(idPedido, fecha, Now.Hour.ToString + ":" + Now.Minute.ToString, Tb_CliCod.Text, Tb_CliCodZona.Text, Tb_Observaciones.Text, "1", "1", "1")
            ...
            Next
            'grabar estado del pedido
            L_PedidoEstados_Grabar(idPedido, "11", Date.Now.Date.ToString("yyyy/MM/dd"), Now.Hour.ToString + ":" + Now.Minute.ToString, gs_usuario)
...
#End Region
    ...
    Private Sub PanelEx6_Click(sender As Object, e As EventArgs) Handles PanelEx6.Click
    ...
    Private Sub PanelEx7_Click(sender As Object, e As EventArgs) Handles PanelEx7.Click

    End Sub

    Private Sub BBtn_Nuevo_Click(sender As Object, e As DevComponents.DotNetBar.ClickEventArgs) Handles BBtn_Nuevo.Click, btNuevo.Click
        _PNuevoRegistro()
    End Sub
    ...
    Private Sub Tb_CantProd_KeyDown(sender As Object, e As KeyEventArgs) Handles Tb_CantProd.KeyDown
        If e.KeyData = Keys.Enter Then
            ...
            precio = JGr_DetallePedido.CurrentRow.Cells("Precio").Value
            JGr_DetallePedido.CurrentRow.Cells("Monto").Value = Int(Tb_CantProd.Text) * precio
    ...
    Private Sub BBtn_Grabar_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Grabar.Click, btGrabar.Click
        _PGrabarRegistro()
    End Sub
    ...
    Private Sub BBtn_Cancelar_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Cancelar.Click, btSalir.Click
        _PSalirRegistro()
    End Sub
    ...
    Private Sub BBtn_Modificar_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Modificar.Click, btModificar.Click
        _PModificarRegistro()
    End Sub

    Private Sub BBtn_Eliminar_Click(sender As Object, e As ClickEventArgs) Handles BBtn_Eliminar.Click, btEliminar.Click
        _PEliminarRegistro()
    End Sub
    ...
    Private Sub JGr_Clientes_SelectionChanged(sender As Object, e As EventArgs) Handles JGr_Clientes.SelectionChanged
        If JGr_Clientes.Row >= 0 Then
            ...
            Try
                Tb_DireccionDetalle.Text = Convert.ToString(JGr_Clientes.CurrentRow.Cells("CliDireccion").Value)
            Catch ex As Exception
    ...
    Private Sub JGr_UltimosPedidos_DoubleClick(sender As Object, e As EventArgs) Handles JGr_UltimosPedidos.DoubleClick
        If JGr_UltimosPedidos.Row >= 0 Then
            ...
            Dim codPedido As Integer = JGr_UltimosPedidos.GetValue("CodPedido")
    ...
    Private Sub ANULARPEDIDOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ANULARPEDIDOToolStripMenuItem.Click
        ...
        'If obs <> String.Empty Then
        '    L_PedidoReclamos_Grabar(numi, codPedido, "1", obs.ToUpper, "3")
        '    'L_PedidoCabacera_ModificarEstado(codPedido, "8")
        '    L_PedidoCabacera_ModificarActivoPasivo(codPedido, "2")
    ...
    Private Sub FlyoutUsuario_PrepareContent(sender As Object, e As EventArgs) Handles FlyoutUsuario.PrepareContent
        If sender Is BubbleBar5 And btGrabar.Enabled = False Then
    ...
    Private Sub REGERARPEDIDOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles REGERARPEDIDOToolStripMenuItem.Click
        ...
        If estado = 4 Then
            ...
            'generar la copia del pedido
            Dim numiNew As String = L_PedidoGenerarCopia(codPedido)

            Dim frm As New F0_IngresarReclamo(codPedido, "1", "1")
            frm.GroupPanel2.Text = "INGRESE EL RECLAMO DEL PEDIDO REGENERADO"
            frm.ShowDialog()
            If frm.respuesta = False Then
                If JGr_Clientes.Row >= 0 Then
                    Dim codCliente As Integer = JGr_Clientes.GetValue(0)
                    _PCargarGridRegistrosPedidos(JGr_UltimosPedidos, codCliente)
                End If
            ...
            'Dim numi As String = ""
            'Dim obs As String = InputBox("INGRESE EL RECLAMO DEL PEDIDO REGENERADO", "RECLAMO DEL CLIENTE", "")
            'If obs <> String.Empty Then
            '    L_PedidoReclamos_Grabar(numi, numiNew, "1", obs.ToUpper, "1")
        ...
        Else
            MessageBox.Show("no se puede regenerar este pedido por que aun esta sin entregar".ToUpper)
        End If
    End Sub
