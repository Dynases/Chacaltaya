...
#Region "Metodos Privados"
    ...
    Private Sub _PMostrarRegistro(_N As Integer)
        ...
        With JGr_Buscador
            ...
            '''''''''''''RELOJJJJJJJ''''''''''
            tbReloj.Value = IIf(IsDBNull(.GetValue("cbreloj")) = True, False, .GetValue("cbreloj"))
    ...
    Public Sub _prRegistrarEmpleadoAlReloj()
        ...
        If (TableEmpleado.Rows.Count > 0) Then
            For i As Integer = 0 To TableEmpleado.Rows.Count - 1 Step 1
                Dim sdwEnrollNumber As Integer = TableEmpleado.Rows(i).Item("cbnumi")
