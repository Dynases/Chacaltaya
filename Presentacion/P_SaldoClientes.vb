...
#End Region
    ...
    Private Sub P_LlenarDatosGrilla()
        ...
        _Ds = New DataSet
        _Ds = L_ObtenerSaldoCliente(_modo)
    ...
    Private Sub P_GenerarReporte()
        ...
        Dim objrep As New R_SaldoClientes
