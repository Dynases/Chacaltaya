...
#Region "Metodos Privados"
    ...
    Private Sub _prAsignarPermisos()
        ...
        Dim dtRolUsu As DataTable = L_RolDetalle_General2(-1, idRolUsu, "ycyanumi=80")
    ...
    Private Sub _prCargarVenta()
        ...
        If (tbTablet.Value = True) Then
            dt = L_prMovimientoChoferGeneralEntradaTop20(24)
        Else
            dt = L_prMovimientoChoferGeneralEntrada(24)
        End If
