...
Public Class P_PrecioProductos
...
#Region "Metodos"
    ...
    Private Sub _PAsignarPermisos()
        ...
        Dim dtRolUsu As DataTable = L_RolDetalle_General2(-1, idRolUsu, "ycyanumi=3")
        Dim show As Boolean = dtRolUsu.Rows(0).Item("ycshow")
        Dim add As Boolean = dtRolUsu.Rows(0).Item("ycadd")
        modif = dtRolUsu.Rows(0).Item("ycmod")
        Dim del As Boolean = dtRolUsu.Rows(0).Item("ycdel")

        If add = False Then
            btAddCategoria.Visible = False
        End If
        If modif = False Then
    ...
    Private Sub _PAdicionarCategoria()
        ...
        Else
            ...
            Dim numi As String = ""
            L_CategoriaPrecioGrabar(numi, sigCategoria, catDesc.ToUpper)
