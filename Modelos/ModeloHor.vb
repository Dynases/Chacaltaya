Public Class ModeloHor
    ...
    Private Sub ModeloHor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Txt_NombreUsu.Text = M_Global.G_Usuario
        Txt_NombreUsu.ReadOnly = True

        Dim _color As Color = _prGetColorFromHex(M_Global.gs_color)

        Me.PanelEx1.Style.BackColor1.Color = _color
        Me.PanelEx1.Style.BackColor2.Color = _color

        Me.PanelEx2.Style.BackColor1.Color = _color
        Me.PanelEx2.Style.BackColor2.Color = _color

        Me.PanelEx5.Style.BackColor1.Color = _color
        Me.PanelEx5.Style.BackColor2.Color = _color
    End Sub
