...
#Region "Meseros"
    ...
    Public Shared Sub L_modificar_Meseros(ByRef _id As String, _ci As String, _nombre As String, _estado As String)
        ...
        "cfCI ='" + _ci + "', " + _
        "cfest = '" + _estado + "', " + _
        "cffact = '" + Left(Today.Date.ToString, 10) + "', " + _
...
#Region "Libreria"
    ...
    Public Shared Sub L_Modificar_LibreriasCabecera(_id As String, _con As String, _desc As String)
        ...
        Sql = "cdcon =" + _con + ", " + _
        "cddesc ='" + _desc + "', " + _
        "cdfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
    ...
    Public Shared Sub L_Modificar_LibreriasDetalle(_id As String, _con As String, _num As String, _desc As String)
        ...
        "cenum =" + _num + ", " + _
        "cedesc ='" + _desc + "', " + _
        "cefact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "NivelesLibrerias"
    ...
    Public Shared Sub L_Modificar_NivelesLibreriasCabecera(_id As String, _desc As String)
        ...
        Sql = "cfdesc ='" + _desc + "', " + _
        "cffact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
        "cfhact = '" + Now.Hour.ToString + ":" + Now.Minute.ToString + "', " +
        "cfuact = '" + "DANNY" + "'"
...
#Region "Farmacia Nota Entrega"
    Public Shared Function L_VistaNotaEntrega(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        If _Modo = 0 Then
            _Where = " TC006.cfid = TC006.cfId"
        Else
            _Where = "((TS001.saclen)=TY004.ydper) And ((TY004.ydcli)=1) And ((TS001.sanumi)=TS0011.sbnumi) And ((TS0011.sbcprod)=TY005.yfcprod)" + _
...
#Region "Zona"
    ...
    Public Shared Function L_ZonaCabecera_GeneralCompleto1(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Else
            _Where = _Cadena
        End If
        _Tabla = D_Datos_Tabla("lanumi, lacity ,c.cedesc,laprovi,cc.cedesc, lazona,ccc.cedesc,lacolor", "TL001,TC005 b, TC005 bb, TC005 bbb, TC0051 c, TC0051 cc, TC0051 ccc", _Where + " order by lanumi")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    ...
    Public Shared Sub L_ZonaCabacera_Modificar(_numi As String, _city As String, _provi As String, _zona As String, _color As String)
        ...
        "lazona =" + _zona + ", " + _
        "lacolor = '" + _color + "', " + _
        "lafact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
    ...
    Public Shared Sub L_ZonaDetallePuntos_Modificar(_id As String, _latitu As String, _longitud As String)
        ...
        Sql = "lblat =" + _latitu + ", " + _
        "lblongi =" + _longitud + ", " + _
        "lbfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Empleados"
    ...
    Public Shared Function L_Empleado_General_ProgramaZona(_Modo As Integer, Optional _Cadena As String = "", Optional _order As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String
        If _Modo = 0 Then
        ...
        _Tabla = D_Datos_Tabla("cbnumi,cbdesc,cast(0 as bit) as [check]", "TC002,TC0051", _Where + _order)
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    ...
    Public Shared Function L_Empleado_General(_Modo As Integer, Optional _Cadena As String = "", Optional _order As String = "") As DataSet
        ...
        _Tabla = D_Datos_Tabla("cbnumi,cbdesc,cbdirec,cbtelef,cbcat,cedesc,cbsal,cbci,cbobs,cbfnac,cbfing,cbfret,cbfot,cbest,cbeciv,cbplan,cbreloj", "TC002,TC0051", _Where + _order)
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    ...
    Public Shared Sub L_Empleado_Grabar(ByRef _numi As String, _desc As String, _direc As String, _telef As String, _categ As String, _salario As String, _ci As String, _obs As String, _fechaNac As String, _fechaIngreso As String, _fechaRetiro As String, ByRef _foto As String, _estado As String, _estadoCivil As String, _planilla As String, _careloj As Integer)
        ...
        Dim Sql As String
        Sql = _numi + ",'" + _desc + "','" + _direc + "','" + _telef + "'," + _categ + "," + _salario + ",'" + _ci + "','" + _obs + "','" + _fechaNac + "','" + _fechaIngreso + "','" + _fechaRetiro + "','" + _foto + "'," + _estado + ",'" + _estadoCivil + "'," + _planilla + "," + Str(_careloj).Trim + "," + _Actualizacion
    ...
    Public Shared Sub L_Empleado_Modificar(_numi As String, _desc As String, _direc As String, _telef As String, _categ As String, _salario As String, _ci As String, _obs As String, _fechaNac As String, _fechaIng As String, _fechaRetiro As String, ByRef _foto As String, _estado As String, _estadoCivil As String, _planilla As String)
        ...
        "cbfnac = '" + _fechaNac + "', " + _
        "cbfing = '" + _fechaIng + "', " + _
        "cbfret = '" + _fechaRetiro + "', " + _
        "cbfot = '" + _foto + "', " + _
        "cbest = " + _estado + ", " + _
        "cbeciv = '" + _estadoCivil + "', " + _
        "cbplan =" + _planilla + "," + _
        "cbfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Precios Productos"
    ...
    Public Shared Sub L_PrecioProd_Modificar(_numi As String, _codProd As String, _catCliente As String, _precio As String)
        ...
        Sql = "chcprod = '" + _codProd + "' , " + _
        "chcatcl = " + _catCliente + " , " + _
        "chprecio = " + _precio + " , " + _
        "chfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Metodos Guido"
    Public Shared Function L_ProductosPedido_General(_Modo As Integer, Optional _CatProd As String = "", Optional _CatClie As String = "", Optional _ordenEspecifico As String = "0") As DataTable
        ...
        Else
            _Where = "cacat=" + _CatProd + " AND cacod=chcprod AND chcatcl=" + _CatClie + " AND caest=1"
        End If
        _Tabla = D_Datos_Tabla("cacod,cadesc,chprecio,caimg,castc, " + _ordenEspecifico + " as orden", "TC001,TC003", _Where + " order by orden,canumi")
    ...
    Public Shared Function L_Productos_GeneralFiltrado2(_Modo As Integer, Optional _Cadena As String = "") As DataTable
        ...
        Else
            _Where = _Cadena
        End If
        _Tabla = D_Datos_Tabla("cacod,cadesc", "TC001", _Where + " order by canumi")
...
#Region "Pedidos"
    ...
    Public Shared Function L_PedidoCabecera_General(_Modo As Integer, Optional _Cadena As String = "") As DataTable
        ...
        End If
        _Tabla = D_Datos_Tabla("DISTINCT oanumi,oafdoc,oahora,oaccli,ccdesc,ccdirec,cctelf2,cccat,oazona,cedesc,oaobs,oaobs2,oaest,cclat,cclongi,oaap,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi)>0,1,0 ) as reclamo,oapg,ccultvent,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi and oftip=1)>0,1,0 ) as tipoRecCliente,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi and oftip=2)>0,1,0 ) as tipoRecRepartidor", "TO001,TC004,TC0051,TL001", _Where + " order by oanumi")
        Return _Tabla
    End Function
    Public Shared Function L_PedidoCabecera_GeneralTOPN(_Modo As Integer, Optional _Cadena As String = "", Optional ByVal _top As String = "") As DataTable
        ...
        Dim _Where As String
        If _Modo = 0 Then
            _Where = " ccnumi=oaccli AND oazona=lanumi AND cecon=2 AND lazona=cenum "
        Else
            _Where = " ccnumi=oaccli AND oazona=lanumi AND cecon=2 AND lazona=cenum " + _Cadena
        End If
        If _top <> String.Empty Then
            _top = " TOP " + _top
        End If

        _Tabla = D_Datos_Tabla(_top + " oanumi,oafdoc,oahora,oaccli,ccdesc,ccdirec,cctelf2,cccat,oazona,cedesc,oaobs,oaobs2,oaest,cclat,cclongi,oaap,oapg,ccultvent", "TO001,TC004,TC0051,TL001", _Where + " order by oanumi desc")
        Return _Tabla
    End Function
    ...
    Public Shared Function L_PedidoCabecera_GeneralSoloRepartidor(_Modo As Integer, Optional _Cadena As String = "") As DataTable
        ...
        End If
        _Tabla = D_Datos_Tabla("DISTINCT oanumi,oafdoc,oahora,oaccli,ccdesc,ccdirec,cctelf2,cccat,oazona,cedesc,oaobs,oaobs2,oaest,cclat,cclongi,oaap,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi)>0,1,0 ) as reclamo,oapg,ccultvent,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi and oftip=1)>0,1,0 ) as tipoRecCliente,IIF((select COUNT(ofnumiped) from TO0014 where ofnumiped=oanumi and oftip=2)>0,1,0 ) as tipoRecRepartidor", "TO001,TC004,TC0051,TL001,TL0012", _Where + " order by oanumi")
        Return _Tabla
    End Function
    ...
    Public Shared Sub L_PedidoCabecera_Grabar(ByRef _numi As String, _fecha As String, _hora As String, _idCli As String, _zona As String, _obs As String, _estado As String, _activoPasivo As String, _pedGen As String)
        Dim _Actualizacion As String
        Dim _Err As Boolean
        Dim _Tabla As DataTable
        ...
        _Actualizacion = "'" + Date.Now.Date.ToString("yyyy/MM/dd") + "', '" + Now.Hour.ToString + ":" + Now.Minute.ToString + "' ,'" + L_Usuario + "'"
        Dim Sql As String
        Sql = _numi + ",'" + Date.Now.Date.ToString("yyyy/MM/dd") + "','" + _hora + "'," + _idCli + "," + _zona + ",0,'" + _obs + "',''," + _estado + "," + _activoPasivo + "," + _pedGen + "," + _Actualizacion
        _Err = D_Insertar_Datos("TO001", Sql)
    End Sub

    Public Shared Sub L_PedidoCabacera_Modificar(_numi As String, _fecha As String, _hora As String, _idCli As String, _zona As String, _obs As String, _estado As String)
        Dim _Err As Boolean
        Dim Sql, _where As String
        ...
        "oaobs = '" + _obs + "', " + _
        "oaest =" + _estado + ", " + _
        "oafact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
    ...
    Public Shared Function L_PedidoGenerarCopia(numi As String) As String
        ...
        'grabar cabecera
        Dim numiNew, numiCli, numiZona, obs As String
        ...
        numiNew = ""
        L_PedidoCabecera_Grabar(numiNew, Now.Date.ToString("yyyy/MM/dd"), Now.Hour.ToString("00") + ":" + Now.Minute.ToString("00"), numiCli, numiZona, obs, "1", "1", "2")
    ...
    Public Shared Function L_PedidoDetalle_General(_Modo As Integer, Optional _idCabecera As String = "") As DataTable
        ...
        Else
            _Where = "obnumi=" + _idCabecera + "AND obcprod=cacod"
        End If
    ...
    Public Shared Function L_PedidoReclamos_General(_Modo As Integer, Optional _idCabecera As String = "", Optional _order As String = "") As DataTable
        ...
        End If
        _Tabla = D_Datos_Tabla("ofnumi,ofnumiped,cedesc,oftip,IIF(oftip=1,'REC. CLIENTE',IIF(oftip=2,'REC. REPARTIDOR',IIF(oftip=3,'ANULACION', 'NOTAS'))) as oftip2,ofest,IIF(ofest=1,'PENDIENTE',IIF(ofest=2,'DICTADO','ENTREGADO')) as ofest2,ofobs,ofconcep,offact,ofhact,ofuact", "TO0014,TC0051", _Where + _order)
        Return _Tabla
    End Function
    ...
    Public Shared Sub L_PedidoDetalleFrecuencia_Modificar(_idCabecera As String, _diasSemana As String, _cadaCiertoDia As String, _diaMes As String)
        ...
        Sql = "ohdiassem ='" + _diasSemana + "', " + _
        "ohdias =" + _cadaCiertoDia + ", " + _
        "ohdiames = " + _diaMes
...
#Region "Descuentos Fijos"
    ...
    Public Shared Sub L_DescuentoFijo_Modificar(_numi As String, _tipo As String, _valor As String, _codPersona As String, _obs As String, _vencimiento As String, _fechaVenci As String)
        ...
        Sql = "patipo = " + _tipo + ", " + _
        "pavalor = " + _valor + " , " + _
        "pacper = " + _codPersona + " , " + _
        "paobs = '" + _obs + "', " + _
        "pavenc = " + _vencimiento + ", " + _
        "pafvenc = '" + _fechaVenci + "', " + _
        "pafact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Bonos Descuentos"
    ...
    Public Shared Sub L_BonosDescuentosCabecera_Modificar(ByRef _numi As String, _codPersona As String, _año As String, _mes As String)
        ...
        Sql = "pbcper = " + _codPersona + ", " + _
        "pbano = " + _año + " , " + _
        "pbmes = " + _mes + " , " + _
        "pbfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Bono Antiguedad"
    ...
    Public Shared Sub L_BonosAntiguedad_Modificar(_numi As String, _meses As String, _monto As String)
        ...
        Sql = "pdmeses = " + _meses + ", " + _
        "pdmonto = " + _monto + " , " + _
        "pdfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Vacacion"
    ...
    Public Shared Sub L_Vacacion_Modificar(_numi As String, _meses As String, _dias As String, _fechaVigencia As String, _tipo As String)
        ...
        Sql = "pemeses = " + _meses + ", " + _
        "pedias = " + _dias + " , " + _
        "pefvig = '" + _fechaVigencia + "', " + _
        "petipo = " + _tipo + " , " + _
        "pefact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Planilla de sueldos"
    Public Shared Function L_PAPlanillaSueldos(fecha As String) As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("PlanillaSueldo", _listParam)
        Return _Tabla
    End Function
    ...
    Public Shared Function L_PAPlanillaSueldosGrabados(_anio As String, _mes As String, planilla As String) As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_dg_TP008", _listParam)
        Return _Tabla
    End Function
...
#Region "Feriados"
    ...
    Public Shared Sub L_Feriado_Modificar(_numi As String, _fechaFeriado As String, _descripcion As String)
        ...
        Sql = "pfflib = '" + _fechaFeriado + "', " + _
        "pfdes = '" + _descripcion + "' , " + _
        "pffact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
...
#Region "Pedido Vacacion"
    ...
    Public Shared Sub L_PedidoVacacionCabecera_Modificar(_numi As String, _codPersona As String, _fechaDoc As String, _estado As String, _obs As String, _fIng As String, _fSal As String, _dias As String)
        ...
        "pgfing = '" + _fIng + "', " + _
        "pgdias = " + _dias + " , " + _
        "pgfact = '" + Date.Now.Date.ToString("yyyy/MM/dd") + "', " + _
    ...
    Public Shared Sub L_PedidoVacacionDetalle_Modificar(_idCabecera As String, _fechaSalida As String, _fechaIngreso As String, _dias As String)
        ...
        Sql = "phfsal ='" + _fechaSalida + "', " + _
        "phfing ='" + _fechaIngreso + "', " + _
        "phdias =" + _dias
...
#Region "Producto"
    ...
    Public Shared Function L_GrabarEliminarProducto(ByVal _Where As String) As Boolean
        Try
            Return D_Eliminar_Datos("TC001", _Where)
        Catch ex As Exception
            Return False
        End Try
    End Function
...
#Region "Clientes"
    ...
    Public Shared Function L_fnGrabarCliente(ByRef numi As String, cod As String, desc As String, zona As String,
                                             ...
                                             fecing As String, ultvent As String, detalle As DataTable) As Boolean
        ...
        _Tabla = D_ProcedimientoConParam2("sp_go_TC004", _listParam)
        If _Tabla.Rows.Count > 0 Then
    ...
    Public Shared Function L_fnGrabarClienteValidarBDDist2(numi As String) As Boolean
        Dim _resultado As Boolean
        ...
        Else
            _resultado = False
        End If
        Return Not _resultado
    End Function

    Public Shared Function L_fnGrabarClienteBDist2(ByRef numi As String, cod As String, desc As String, zona As String,
                                             dct As String, dctnum As String, direc As String, telf1 As String,
                                             telf2 As String, cat As String, est As String, lat As String,
                                             lon As String, prconsu As String, even As String, obs As String,
                                             fnac As String, nomfac As String, nit As String, ultped As String,
                                             fecing As String, ultvent As String) As Boolean
        Dim _resultado As Boolean
    ...
    Public Shared Function L_fnModificarCliente(ByRef numi As String, cod As String, desc As String, zona As String,
                                             ...
                                             ultped As String, fecing As String, ultvent As String,
    ...
    Public Shared Function L_GetTabla(_NomTabla As String, _Campo As String, _Where As String) As DataTable
        Dim _Tabla As DataTable
        _Tabla = D_Datos_Tabla(_Campo,
                               _NomTabla,
                               _Where)
    ...
    Public Shared Function L_GetRepartidor(Optional _where1 As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String
        If _where1 = String.Empty Then
        ...
        Else
            _Where = _where1
        End If
        _Tabla = D_Datos_Tabla("b.cbnumi, b.cbdesc,  b.cbdirec",
                               " TC002 b",
                               _Where)
        _Ds.Tables.Add(_Tabla)
        Return _Ds
...
#Region "Notas"
    ...
    Public Shared Function L_GetPrecioCategoriaCliente(ccli As String, cprod As String, ByRef flat As Boolean) As Double
        ...
        If (_Tabla.Rows.Count > 0) Then
            flat = (IIf(IsDBNull(_Tabla.Rows(0).Item("chprecio")), False, True))
            Return (IIf(IsDBNull(_Tabla.Rows(0).Item("chprecio")), 0, CDbl(_Tabla.Rows(0).Item("chprecio").ToString)))
        Else
            flat = False
            Return 0
        End If
    ...
    Public Shared Function L_GetPrecioCategoriaOficina(cprod As String, ByRef flat As Boolean) As Double
        Dim _Tabla As DataTable
        _Tabla = D_Datos_Tabla("chprecio", "TC003", "chcatcl=0 and chcprod=" + cprod)
        If (_Tabla.Rows.Count > 0) Then
            flat = (IIf(IsDBNull(_Tabla.Rows(0).Item("chprecio")), False, True))
            Return (IIf(IsDBNull(_Tabla.Rows(0).Item("chprecio")), 0, CDbl(_Tabla.Rows(0).Item("chprecio").ToString)))
        Else
...
#Region "Usuarios"
    ...
    Public Shared Function L_Usuario_General3(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Else
            _Where = _Cadena
        End If
        _Tabla = D_Datos_Tabla("ZY003.ydnumi,ZY003.yduser, cast(0 as bit) as [check]", "ZY003", _Where + " order by yduser")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
...
#Region "Movimiento"
    ...
    Public Shared Function L_ProductosGeneral(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Else
            _Where = _Cadena
        End If
        _Tabla = D_Datos_Tabla("canumi,cadesc,cadesc2", "TC001", _Where + " order by canumi")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    ...
    Public Shared Function L_MovimientosGeneral(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Return _Ds
    End Function
    Public Shared Function L_BusquedaDeEquipos() As DataSet
        ...
        _tabla = D_ProcedimientoConParam2("sp_af_reportesAlberth", _listParam)
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    Public Shared Function L_BusquedaDeProductos() As DataSet
    ...
    Public Shared Sub L_Grabar_MovimientosDetalle(_id As String, _codProd As String, _cant As String)
        ...
        Sql = _id + "," + _codProd + "," + _cant

        '_Err = D_Insertar_Datos("TI0021", Sql)
        _Err = D_Insertar_Datos("TI0021 (icibid,iccprod,iccant)", Sql)
    End Sub
...
#Region "CATEGORIAS PRECIOS"
    ...
    Public Shared Function L_CategoriaPrecioModificar(ByRef _numi As String, _fApertura As String, _fCierre As String, _turno As String, _obs As String, _user As String, _estado As String, _efectivo As String) As Boolean
        ...
        "odest = " + _estado + ", " + _
        "odefec = " + _efectivo + ", " + _
        "odfact = '" + Left(Today.Date.ToString, 10) + "', " + _
...
#Region "Vistas"
    ...
    Shared Function L_VistaFacturas(_fIni As String, _fFin As String, _nini As String, _nfin As String) As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String

        _Where = "odfdoc>='" + _fIni + "' And odfdoc<='" + _fFin + "' And oenfac <> 0 "
        If (Not _nini.Equals("0") Or Not _nfin.Equals("0")) Then
            _Where = _Where + " and oenfac>=" + _nini + " and oenfac<=" + _nfin
        End If
...
#Region "Kardex de Clientes"
    ...
    Shared Function L_VistaKadexClienteUltimo(ccli As String, fIni As String, fFin As String) As DataSet
        ...
        Dim campos As String = "tprod, grupo, nnota, ccli, nombre, fecha, concepto, con, cre, pago, saldo, nota, tipo, factura"
...
#Region "Kardex de Inventario"
    ...
    Shared Function L_VistaKardexInventario(cod As String, fIni As String, fFin As String) As DataSet
        ...
        If (cod.Equals("-1")) Then
            _Where = "cprod = " + cod + " And fdoc >= '" + fIni + "' And fdoc <= '" + fFin + "' and est<10"
        Else
            _Where = "cprod = " + cod + " And fdoc >= '" + fIni + "' And fdoc <= '" + fFin + "' and est<10"
        End If
    ...
    Shared Function L_VistaKardexInventarioTodo(cod As String, Optional fFin As String = "") As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String = "cprod = " + cod + IIf(fFin.Equals(""), "", " And fdoc < '" + fFin + "' and est<10")
        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_KardexInventario", _Where + " order by fdoc")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
...
#Region "GET CLASES"
    Public Shared Function L_ClaseGetCliente(_numi As String, Optional _Cadena As String = "") As Client
        ...
        _campos = "ccnumi,cccod,ccdesc,cczona,ccdct,ccdctnum,ccdirec,cctelf1,cctelf2,cccat,ccest,cclat,cclongi," + _
        ...
        If _Tabla.Rows.Count > 0 Then
            With _Tabla.Rows(0)
                objCliente = New Client(.Item("ccnumi").ToString, .Item("cccod").ToString, .Item("ccdesc").ToString, .Item("cczona").ToString, .Item("ccdct").ToString, .Item("ccdctnum").ToString, .Item("ccdirec").ToString, _
                                    .Item("cctelf1").ToString, .Item("cctelf2").ToString, .Item("cccat").ToString, .Item("ccest").ToString, .Item("cclat").ToString, .Item("cclongi").ToString, .Item("ccprconsu").ToString, _
                                    .Item("cceven").ToString, .Item("ccobs").ToString, .Item("ccfnac").ToString, .Item("ccnomfac").ToString, .Item("ccnit").ToString, .Item("ccultped").ToString, .Item("ccfecing").ToString, _
                                    .Item("ccultvent").ToString, .Item("ccfact").ToString, .Item("cchact").ToString, .Item("ccuact").ToString)
            End With
        Else
            objCliente = Nothing
        End If
    ...
    Public Shared Function L_ClaseGetProducto(_numi As String, Optional _Cadena As String = "") As Product
        ...
        If _Tabla.Rows.Count > 0 Then
            With _Tabla.Rows(0)
                objProducto = New Product(.Item("canumi"), .Item("cacod"), .Item("cadesc"), .Item("cadesc2"), .Item("cacat"), .Item("caimg"), .Item("castc"), _
...
#Region "TC009 MANUALES"
    ...
    Public Shared Function L_fnManuales() As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_go_TC009", _listParam)
    ...
    Public Shared Function L_fnModificarManualUsuario(ByRef numi As String) As Boolean
        Dim _resultado As Boolean
...
#Region "TC010 PROVEEDOR"
    ...
    Public Shared Function L_fnProveedores() As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_go_TC010", _listParam)
...
#Region "TCP001 CUENTAS POR PAGAR"
    ...
    Public Shared Function L_fnCuentasPagar() As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_go_TCP001", _listParam)
    ...
    Public Shared Function L_fnGrabarCuentaPagar(ByRef numi As String, prov As String,
                                                ...
                                                tcom As String, ffec As String, fnit As String, frsocial As String,
        ...
        If (fpro = "1") Then
            _listParam.Add(New Datos.DParametro("@tcom", tcom))
    ...
    Public Shared Function L_fnModificarCuentaPagar(ByRef numi As String, prov As String,
                                                ...
                                                Optional tcom As String = "", Optional ffec As String = "", Optional fnit As String = "", Optional frsocial As String = "",
...
#Region "TC011 TURNOS"
    ...
    Public Shared Function L_prTurnoGeneral() As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_dg_TC011", _listParam)
...
#Region "TZ001 Interfaz Marcador"
    ...
    Public Shared Function L_prInterfazMarcadorGrabar(tabla As DataTable) As Boolean
        ...
        _Tabla = D_ProcedimientoConParam2("sp_dg_TZ001", _listParam)
...
#Region "TP007"
    Public Shared Function L_prPersonaAyudaTodosGeneralCorrMarcado() As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 666))
        _listParam.Add(New Datos.DParametro("@piuact", L_Usuario))

        _Tabla = D_ProcedimientoConParam2("sp_dg_TP007", _listParam)
...
#Region "BDDist TCI001"
    Public Shared Function L_ObtenerDatosTCI001(tipo As String) As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_go_TCI001", _listParam)
...
#Region "VR_GO_KardexPrestamosAgrupado"
    ...
    Shared Function L_VistaPrestamoEquiposAgrupado(codCli As String, where As String) As DataTable
        Dim Tabla As DataTable
        If (codCli = String.Empty) Then
            where = IIf(where = String.Empty, " 1=1 ", " 1=1 " + where)
        Else
            where = IIf(where = String.Empty, "1=1 and chnumi=" + codCli, "chnumi=" + codCli + where)
        End If
        ...
        Return Tabla
    End Function
    Shared Function L_VistaPrestamoEquiposAgrupadoRepartidor(codCli As String, where As String) As DataTable
        Dim Tabla As DataTable
        If (codCli = String.Empty) Then
            where = IIf(where = String.Empty, " 1=1 ", " 1=1 " + where)
        Else
            where = IIf(where = String.Empty, "1=1 and cbnumi=" + codCli, "cbnumi=" + codCli + where)
        End If
...
#Region "VR_SaldoPrestamoEquiposUV"
    ...
    Shared Function L_VistaSaldoPrestamoEquiposUV(fecha As String, czona As String) As DataTable
        ...
        _Tabla = D_Datos_Tabla(campos, "VR_GO_SaldoPrestamoEquiposUV", _Where + " order by [desc] asc")
        Return _Tabla
    End Function
...
#Region "TO0023"
    ...
    Public Shared Function L_fnGrabarTO0023(ByRef numi As String, tc1 As String, tc4 As String, cant As String,
        ...
        _Tabla = D_ProcedimientoConParam2("sp_go_TO0023", _listParam)
        If _Tabla.Rows.Count > 0 Then
            numi = _Tabla.Rows(0).Item(0)
            _resultado = True
        Else
...
#Region "RELOJ"
    Public Shared Function L_prAsistenciaGeneralReloj() As DataTable
        Dim _Tabla As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TC002", _listParam)
    ...
    Public Shared Function L_prMarcacionGrabar(ByRef _ldnumi As String, _TZ001 As DataTable) As Boolean
        ...
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@cbnumi", _ldnumi))
        _listParam.Add(New Datos.DParametro("@cbuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@TR001", "", _TZ001))
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TC002", _listParam)
    ...
    Public Shared Function L_prObtenerNombreEmpleado(_panumi As Integer) As DataTable
        ...
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _listParam.Add(New Datos.DParametro("@cbnumi", _panumi))
        _listParam.Add(New Datos.DParametro("@cbuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TC002", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_prEmpleadoNoRegistradoGeneral() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prMarcacionGrabarEstadoEmpleadosReloj(ByRef _cbnumi As String, _TC002 As DataTable) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@cbnumi", _cbnumi))
        _listParam.Add(New Datos.DParametro("@cbuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@TC002", "", _TC002))
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TC002", _listParam)

        If _Tabla.Rows.Count > 0 Then
            _cbnumi = _Tabla.Rows(0).Item(0)
            _resultado = True
        Else
            _resultado = False
        End If
...
#Region "VR_GO_DiferenciaPedidoNota"

    Shared Function L_VistaDiferenciaPedidoNota(usuario As String, fini As String, ffin As String, criterio As Byte, flat As Boolean) As DataTable
        Dim _Tabla As DataTable
        Dim _Where As String = ""

        If (Not usuario = String.Empty) Then
            If (flat) Then
                _Where = _Where + "repa=" + usuario
            Else
                _Where = _Where + "usuario='" + usuario + "'"
            End If
        End If

        If (Not fini = String.Empty And Not ffin = String.Empty) Then
            If (_Where = String.Empty) Then
                _Where = "fecha>='" + fini + "' and fecha<='" + ffin + "'"
            Else
                _Where = _Where + " and fecha>='" + fini + "' and fecha<='" + ffin + "'"
            End If
        End If
        ...
        Select Case criterio
            Case 1
                _Where = _Where + " and dif<0"
            Case 2
                _Where = _Where + " and dif>0"
        End Select

        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_GO_DiferenciaPedidoNota", _Where + " order by numi asc")
        Return _Tabla
    End Function

#End Region

#Region "VR_GO_FacturaVsVenta2"

    Shared Function L_VistaFacturaVsVenta2(ccli As String, fini As String, ffin As String, criterio As Byte) As DataTable
        Dim _Tabla As DataTable
        Dim _Where As String = ""

        If (Not ccli = String.Empty) Then
            _Where = _Where + "ccli=" + ccli + ""
        End If
        ...
        Select Case criterio
            Case 1
                _Where = _Where + " and ccli in (SELECT ccli " _
                + " FROM VR_GO_FacturaVsVenta2" _
                + " WHERE " + _Where + " and tipo='FACTURA')"
        End Select

        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_GO_FacturaVsVenta2", _Where + " order by lin asc")
        Return _Tabla
    End Function

#End Region

#Region "VR_GO_Cha_KardexCliente_DocCliente"

    Shared Function L_fnVistaChaKadexClienteDocClienteUltimo(ccli As String, fIni As String, fFin As String) As DataTable
        Dim _Tabla As DataTable
        Dim _Where As String

        If (ccli.Equals("-1")) Then
            _Where = "codCliente=" + ccli + " and fecha>='" + fIni + "' and fecha<='" + fFin + "'"
        Else
            _Where = "codCliente=" + ccli + " and fecha>='" + fIni + "' and fecha<='" + fFin + "'"
        End If

        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_GO_Cha_KardexCliente_DocCliente", _Where + " order by fecha")

        Return _Tabla
    End Function

    Shared Function L_fnVistaChaKadexClienteDocClienteTodo(ccli As String, Optional fFin As String = "") As DataTable
        Dim _Tabla As DataTable
        Dim _Where As String = "codCliente=" + ccli + IIf(fFin.Equals(""), "", " and fecha<='" + fFin + "'")
        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_GO_Cha_KardexCliente_DocCliente", _Where + " order by fecha")
    ...
    Shared Function L_fnVistaChaKadexClienteDocClienteMes(ccli As String, Optional mIni As String = "", Optional mFin As String = "",
                                                          Optional aIni As String = "", Optional aFin As String = "") As DataTable
        Dim _Tabla As DataTable
        Dim _Where As String = "codCliente=" + ccli _
                               + IIf(mIni.Equals(""), "", " And Month(fecha)>=" + mIni) _
                               + IIf(mFin.Equals(""), "", " And Month(fecha)<=" + mFin) _
                               + IIf(aIni.Equals(""), "", " And Year(fecha)>=" + aIni) _
                               + IIf(aFin.Equals(""), "", " And Year(fecha)<=" + aFin)
    ...
    Shared Function L_fnVistaChaKadexClienteDocClientePrecio(codCliente As String, fecInicial As String) As DataTable
        Dim _Tabla As DataTable
        Dim _Where As String = "fecha>='" + fecInicial + "'"

        Dim campos As String = "*"
        _Tabla = D_Datos_Tabla(campos, "VR_GO_Cha_KardexCliente_DocCliente_Precio", _Where)
...
#Region "TI002 MOVIMIENTOS DE SALIDA DEL CHOFER BIOPETROL"
    ...
    Public Shared Function L_prMovimientoChoferNoExisteConciliacion(_chofer As Integer, tprod As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TM001", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_prObtenerPEdidosConRetrasos(_idRepartidor As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@ibuact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@idrepartidor", _idRepartidor))
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TM001", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_prMovimientoChoferExisteConciliacionSalida(_chofer As Integer, tprod As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@chofer", _chofer))
        _listParam.Add(New Datos.DParametro("@tprod", tprod))
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TM001SalidaChofer", _listParam)
    ...
    Public Shared Function L_prMovimientoChoferGrabar(ByRef _ibid As String, _ibfdoc As String, _ibconcep As Integer,
                                                      _ibobs As String, _ibidchof As Integer, _idConciliacion As Integer,
                                                      nroNota As String, tprod As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@nota", nroNota))
        _listParam.Add(New Datos.DParametro("@tprod", tprod))
...
#Region "TI002 MOVIMIENTOS DE SALIDA DE PRODUCTOS PARA EL CHOFER BIOPETROL"
    ...
    Public Shared Function L_prMovimientoChoferListarProductosSalida(dt As DataTable, tprod As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prMovimientoChoferGrabarSalida(ByRef _ibid As String, _ibfdoc As String, _ibconcep As Integer,
                                                            _ibobs As String, _ibidchof As Integer, _idConciliacion As Integer,
                                                            _detalle As DataTable, nroNota As String, tprod As String) As Boolean
        Dim _resultado As Boolean
    ...
    Public Shared Function L_prMovimientoChoferModificarSalida(ByRef _ibid As String, _ibfdoc As String,
                                                               _ibconcep As Integer, _ibobs As String,
                                                               _ibidchof As Integer, _detalle As DataTable,
                                                               _icibid As String, nroNota As String, tprod As String) As Boolean
        Dim _resultado As Boolean
...
#End Region
#Region "reportes BONOS Y DESCUENTOS"
    Public Shared Function L_fnListarEmpleados() As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarBonosYDescuentos(tipo As String, anio As String, mes As String, multa As String) As DataTable
        Dim _Tabla As DataTable


        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@pbano", anio))
        _listParam.Add(New Datos.DParametro("@pbmes", mes))
        _listParam.Add(New Datos.DParametro("@tipomulta", multa))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarBonosYDescuentosPorEmpleado(tipo As String, anio As String, mes As String, multa As String, empleado As String) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@pbmes", mes))
        _listParam.Add(New Datos.DParametro("@tipomulta", multa))
        _listParam.Add(New Datos.DParametro("@pcnumi", empleado))
...
#Region "Reporte de ventas por productos"
    Public Shared Function L_prReporteProductos(_fecha1 As String, _fecha2 As String, _producto As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@fecha1", _fecha1))
        _listParam.Add(New Datos.DParametro("@fecha2", _fecha2))
        _listParam.Add(New Datos.DParametro("@producto", _producto))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))

        _Tabla = D_ProcedimientoConParam2("sp_da_VentasProductos", _listParam)

        Return _Tabla
    End Function


    Public Shared Function L_prListarTipo() As DataTable
        Dim _Tabla As DataTable
...
#Region "TC005C  CATEGORIA"
    ...
    Public Shared Function L_prCategoriaGrabar(ByRef _canumi As String, _canombre As String, _cadesc As String, _caimg As String, _estado As Integer) As Boolean
        ...
        _Tabla = D_ProcedimientoConParam2("sp_Mam_TC005C", _listParam)
    ...
    End Function
#End Region
#Region "Saldos vs productos"

    Public Shared Function L_prTraerDesiguales(_m As String) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@m", _m))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))

        _Tabla = D_ProcedimientoConParam2("sp_da_Comparar", _listParam)

        Return _Tabla
    End Function

    Public Shared Function L_prActualizarSaldos(_Vista As DataTable) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 2))
        _listParam.Add(New Datos.DParametro("@VistaType", "", _Vista))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
